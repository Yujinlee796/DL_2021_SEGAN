...
if __name__ == '__main__':
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        for train_batch, train_clean, train_noisy in train_bar:
            ...
            g_spectral_loss = SpectralLoss(generated_outputs, train_clean) #spectral loss
            #g_freqcrop_loss = FreqCropLoss(generated_outputs, train_clean) #freqcrop loss

            # original loss
            # g_loss = g_loss_ + g_cond_loss
            
            # freqcroploss
            # g_loss = g_loss_ + g_cond_loss + g_freqcrop_loss

            # spectralloss
            g_loss = g_loss_ + g_cond_loss + g_spectral_loss
            ...
            train_bar.set_description(
                    'Epoch {}: d_clean_loss {:.4f}, d_noisy_loss {:.4f}, g_loss {:.4f}, g_conditional_loss {:.4f}, g_freq_loss {:.4f}'
                    .format(epoch + 1, clean_loss.data, noisy_loss.data, g_loss.data, g_cond_loss.data, g_freq_loss))
